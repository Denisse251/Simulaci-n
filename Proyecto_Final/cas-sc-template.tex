...
\begin{document}
\shorttitle{Simulación de nanoportadores TNT}
\title [mode = title]{Simulación de Nanotransportador de Titanio con Nanofibras Polimericas de liberación controlada para Vitiligo}      \shortauthors{Denisse Leyva.}              
...
\cormark[1]
\fnmark[1]
\ead{denisse.leyvacs@uanl.edu.mx}
...
\begin{figure}[h]
	\centering
		\includegraphics[scale=.30]{figs/p_t0.png}
