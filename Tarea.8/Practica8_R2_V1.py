# -*- coding: utf-8 -*-
"""
Created on Wed Apr 21 00:58:00 2021
...
for n in ns: 
    ...
    plt.boxplot(PT1,medianprops=medianprops, showfliers=False)
    plt.ylabel('Porcentaje')
    plt.xticks(xt,xt)
    plt.xlabel('Iteraciones')
    plt.savefig('p8_v1_c1_n'+str(n)+'.png', dpi=300)
    plt.show()
    plt.close()
    
    xt = [x for x in range(5,duracion+1,5)]
    medianprops = dict(linestyle='solid', linewidth=3, color='red')
    plt.boxplot(PT2,medianprops=medianprops, showfliers=False)
    plt.ylabel('Porcentaje')
    plt.xticks(xt,xt)
    plt.xlabel('Iteraciones')
    plt.savefig('p8_v1_c2_n'+str(n)+'.png', dpi=300)
    plt.show()
    plt.close()
    
    xt = [x for x in range(5,duracion+1,5)]
    medianprops = dict(linestyle='solid', linewidth=3, color='red')
    plt.boxplot(PT3,medianprops=medianprops, showfliers=False)
    plt.ylabel('Porcentaje')
    plt.xticks(xt,xt)
    plt.xlabel('Iteraciones')
    plt.savefig('p8_v1_c3_n'+str(n)+'.png', dpi=300)
    plt.show()
    plt.close()
    ...
    estadistica = f_oneway(PTT1,PTT2,PTT3)
    print(estadistica)
