# -*- coding: utf-8 -*-
"""
Created on Tue Apr 27 23:58:42 2021
...
if __name__ == "__main__":
    system('DEL -f p9pc_t*.png') # borramos anteriores en el caso que lo hayamos corrido
    n = 25
    ...
    for t in range(tmax):
        with multiprocessing.Pool() as pool: # rehacer para que vea cambios en p
            ...
            plt.close()
            ns.data = p 
    p['v'].to_csv('valor_c.csv')
    popen('magick convert -delay 50 -size 300x300 p9pc_t*.png -loop 0 p9pc.gif') # requiere ImageMagick