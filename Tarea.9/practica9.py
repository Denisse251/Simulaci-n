# -*- coding: utf-8 -*-
"""
Created on Mon Apr 26 12:49:56 2021
...
if __name__ == "__main__":
    system('DEL -f p9pmc_t*.png') # borramos anteriores en el caso que lo hayamos corrido
    n = 25
    ...
    for t in range(tmax):
        with multiprocessing.Pool() as pool: # rehacer para que vea cambios en p
            ...
            plt.close()
            ns.data = p 
    p['v'].to_csv('valor_mc.csv')
    popen('magick convert -delay 50 -size 300x300 p9pmc_t*.png -loop 0 p9pmc.gif') # requiere ImageMagick