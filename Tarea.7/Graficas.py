...
maximo=max(valores)
df1 = pd.read_csv('resultados_15.csv')
df2 = pd.read_csv('resultados_30.csv')
df3 = pd.read_csv('resultados_45.csv')

p1 = df1['15 con 100'],df2['30 con 100'],df3['45 con 100']
p2 = df1['15 con 1000'],df2['30 con 1000'],df3['45 con 1000']
p3 = df1['15 con 10000'],df2['30 con 10000'],df3['45 con 10000']
...
# plt.legend()
plt.savefig('p7_p100.png', dpi=300)
plt.show()
plt.close()
...
plt.axhline(maximo, color = 'green',label='Maximo estimado') 
# plt.legend() 
plt.savefig('p7_p1000.png', dpi=300)
plt.show()
plt.close()
...
plt.axhline(maximo, color = 'green',label='Maximo estimado') 
# plt.legend() 
plt.savefig('p7_p10000.png', dpi=300)
plt.show()
plt.close()
